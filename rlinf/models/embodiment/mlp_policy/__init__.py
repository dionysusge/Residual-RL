...
def get_model(cfg: DictConfig, torch_dtype=torch.bfloat16):
    ...
    if cfg.model_type == "residual_mlp_policy":
        ...
        model = ResidualPolicy(
            ...
            residual_std=residual_cfg.get("std", 0.05),
            residual_scale=residual_cfg.get("scale", 1.0),
            residual_bound=residual_cfg.get("bound", 0.1),
