...
class LiberoEnv(gym.Env):
    ...
    def step(self, actions=None, auto_reset=True):
        ...
        infos["task_ids"] = to_tensor(self.task_ids.copy())
        infos["reset_state_ids"] = to_tensor(self.reset_state_ids.copy())
        infos["episode_step"] = to_tensor(self._elapsed_steps.copy())
